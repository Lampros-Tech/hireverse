                    ...
                    <div class="md:flex  md:-mx-2 ">
                        ...
                        <div class="w-full md:w-3/12 md:mx-3">
                            ...
                            <div class="bg-white p-3 border-t-4 border-black-400">
                                ...
                                <h1 class="text-gray-900 font-bold text-xl leading-8 my-1">Attempt Summery</h1>




                                <ul class="grid grid-cols-2 gap-2 ">
                                    <li class="bg-green-200 rounded-lg shadow-xl"><div class="h-10 m-3 flex"><h1>1</h1></div></li>
                                    <li class="bg-green-200 rounded-lg shadow-xl"><div class="h-10 m-3 flex"><h1>2</h1></div></li>
                                    <li class="bg-green-200 rounded-lg shadow-xl"><div class="h-10 m-3 flex"><h1>3</h1></div></li>
                                    <li class="bg-green-200 rounded-lg shadow-xl"><div class="h-10 m-3 flex"><h1>4</h1></div></li>
                                    <li class="bg-green-200 rounded-lg shadow-xl"><div class="h-10 m-3 flex"><h1>5</h1></div></li>
                                    <li class="bg-green-200 rounded-lg shadow-xl"><div class="h-10 m-3 flex"><h1>6</h1></div></li>
                                </ul>
                            ...
                            <div class="bg-white p-3 border-t-4 border-black-400">
                                ...
                                <h3 class="text-gray-900 font-lg text-center font-bold leading-6">Verbal and logical judgment</h3>
                                <h1 class="text-gray-900  text-center text-xl leading-8 my-1">PASS</h1>

                                <button type="button" class="text-white bg-gray-800 justify-center hover:bg-gray-900 focus:outline-none focus:ring-4 focus:ring-gray-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-gray-800 dark:hover:bg-gray-700 dark:focus:ring-gray-700 dark:border-gray-700">END TEST</button>
                            </div>
