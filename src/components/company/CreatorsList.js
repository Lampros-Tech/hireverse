      ...
      <div className="cr-container">
        ...
        <div className="cr-main">
          <div className='cr-main-content'>
            <img class="p-1 w-14 h-14 rounded-full ring-2 ring-gray-300 dark:ring-gray-500" src="https://i.pravatar.cc/100" alt="Rounded avatar" />
            <h1 className='cr-name'>Name OF The Creator</h1>
          </div>
