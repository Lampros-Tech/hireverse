      ...
      <div className="profile-rightbar-main">
        ...
        <div className="profile-rightbarInfo">
          ...
          <div className="profile-rightbarInfoItem">
            ...
            <span className="profile-rightbarInfoValue">Lorem ipsum dolor sit amet consectetur adipisicing elit. 
            Pariatur eius ea quisquam voluptatibus facilis in quidem nemo harum hic corporis. 
            Velit facilis molestias quaerat atque iusto eligendi laborum accusamus optio.</span>
          </div>
        </div>
        </div>
      </>
