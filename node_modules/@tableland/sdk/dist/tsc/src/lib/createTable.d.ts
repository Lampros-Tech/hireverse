import { CreateTableOptions, CreateTableReceipt, Connection } from "../interfaces";
/**
 ...
 */
export declare function createTable(this: Connection, query: string, options?: CreateTableOptions): Promise<CreateTableReceipt>;
