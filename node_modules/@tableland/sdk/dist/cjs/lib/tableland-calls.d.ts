import { StructureHashResult, ValidateWriteResult, ReadQueryResult, WriteQueryResult, ReceiptResult, Connection } from "./connection.js";
...
declare function read(this: Connection, query: string): Promise<ReadQueryResult>;
...
declare function lockController(this: Connection, tableId: string): Promise<WriteQueryResult>;
