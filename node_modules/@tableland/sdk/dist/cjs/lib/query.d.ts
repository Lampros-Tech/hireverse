 ...
 */
import { ReadQueryResult, WriteQueryResult, Connection, WriteOptions } from "./connection.js";
export declare function resultsToObjects({ rows, columns }: ReadQueryResult): {
    [k: string]: any;
}[];
export declare function read(this: Connection, query: string): Promise<ReadQueryResult>;
