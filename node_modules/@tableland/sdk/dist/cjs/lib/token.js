...
exports.userCreatesToken = void 0;
...
function createToken(signer, params) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const message = new siwe_1.SiweMessage(Object.assign(Object.assign({ 
            // TODO: Validator doesn't make use of the nonce ATM
            nonce: (0, siwe_1.generateNonce)(), domain: "Tableland" }, params), { address: yield signer.getAddress() }));
        ...
        const token = (0, util_1.btoa)(stringify({
            message: messageText,
            signature,
        }));
        return { token };
...
function userCreatesToken(signer, chainId, uri) {
    return __awaiter(this, void 0, void 0, function* () {
        const now = Date.now();
...
exports.userCreatesToken = userCreatesToken;
