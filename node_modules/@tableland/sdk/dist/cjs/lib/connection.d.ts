...
export declare type Columns = Array<{
    name: string;
}>;
export declare type SchemaColumns = Array<{
    name: string;
    type?: string;
    constraints?: string[];
}>;
export declare type Rows = Array<string | number | boolean>;
...
export declare type PrefixOptions = HashOptions | CreateOptions;
export declare type RelayOptions = WriteOptions | SetControllerOptions;
export declare type SkipConfirmOptions = WriteOptions | CreateOptions;
export declare type TimeoutOptions = ConfirmOptions | CreateOptions;
export interface Connection {
     ...
     **/
    options?: CreateOptions) => Promise<CreateTableReceipt>;
    ...
    setController: (controller: string, name: string, options?: SetControllerOptions) => Promise<WriteQueryResult>;
    ...
    waitConfirm: (txnHash: string, options?: ConfirmOptions) => Promise<ReceiptResult>;
